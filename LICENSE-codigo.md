...
Copyright (c) 2026 Olga Angélica Ortiz · OlgaDev.com
...
AGRAVIO O CUALQUIER OTRO MOTIVO, DERIVADA DE, FUERA DE O EN CONEXIÓN CON EL
SOFTWARE O SU USO U OTRO TIPO DE ACCIONES EN EL SOFTWARE.

---

Esta licencia cubre el código de las aplicaciones y demos del curso
(carpetas `app/` y ficheros `.html` de cada clase). Las plantillas y el
material descargable (matrices, checklists, documentos) tienen su propia
licencia — ver [`LICENSE-material.md`](./LICENSE-material.md).
